...
== room_1 == 
    There's two directions here to go, east or west. It's incredibly dark, with only some local fauna lighting the way. It's less lit to the east.
...
{room_2_east_talk_options: |Your guide, exasporated, sighs.}

{room_2_east_talk_options: |"I told you to go west. So, go back the other way, please."}
